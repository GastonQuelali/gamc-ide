...
1. Capa Base (Base Maps): Cartografía base, híbrido, y el histórico de imágenes (17 capas raster).

2. Unidades Administrativas: Límites municipales, comunas, distritos y subdistritos.

3. Información Catastral: Manzanas, predios, registros catastrales y matrices de predios.

4. Planificación y Normativa: Uso de suelo, sectoriales, vías y ochaves.

5. Relieve y Riesgos: Curvas de nivel, Modelo Digital de Elevación (MDT/MDS) y pendientes.

6. Redes Geodésicas: Puntos de control GRS 80 - SIRGAS.
...
1. Fase 1 (Refactorización): Migrar el código actual a una versión estable de la API de ArcGIS (4.x) para garantizar compatibilidad con dispositivos móviles.

2. Fase 2 (Normalización): Implementar el Catálogo de Metadatos para formalizar la propiedad de los datos municipales.

3. Fase 3 (Integración): Conectar el geoportal con la base de datos de recaudaciones o trámites para que el ciudadano pueda consultar el estado de sus procesos geográficamente.
